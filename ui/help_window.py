...
class HelpWindow(QDialog):
    def __init__(self, parent=None):
        ...
        for txt in (
            ...
            "Aura HUD mode shows time, focus score, progress, and cards left.",
            "Pomodoro only mode shows a minimal timer with break states.",
        ...
        for txt in (
            "Mode can switch between Aura HUD, Pomodoro only, and Custom.",
            "Custom mode lets you show or hide focus score, progress bar, and cards left.",
