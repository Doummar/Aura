    ...
    def __init__(self, kind, minutes, details, parent=None):
        ...
        if show_cards or show_focus:
            ...
            if show_focus:
                ...
                card_layout.addWidget(self._label("Average score", "metric-label"), row, 0)
                card_layout.addWidget(
                ...
                card_layout.addWidget(self._label("Stability", "metric-label"), row, 0)
                card_layout.addWidget(
                ...
                card_layout.addWidget(self._label("Best focus streak", "metric-label"), row, 0)
